...
from airflow.hooks.postgres_hook import PostgresHook # to create a hook with external POSTGRES DB
...
def transfer_function(ds, **kwargs):
    ...
    source_cursor = source_conn.cursor() # cursor helps maintaining a connection to POSTGRES while querying DB
